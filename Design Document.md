...
1. Purpose 2. Scope [URL 🔗](#page-0)

2.1 Primary Functionality 2.2 User Interfaces 3. Exclusions, Assumptions, and Limitations 3.1 Exclusions 3.2 Assumptions 3.3 Limitations 4. Solution Design Overview 4.1 Problem Statement 4.2 Solution Architecture 4.3 Architecture Flow 5. Technical Architecture 5.1 Server Specifications 5.2 Technology Stack 5.3 Network & Integration 5.4 Infrastructure/Application Diagram 5.5 Physical Layout 6. Configuration Specification 6.1 Hardware and Software Components 6.2 Software Dependencies 6.3 Environment Variables 6.4 Database Configuration 7. Solution Design Specification 7.1 Software Description 7.2 Coding Standards 7.3 Data Design [URL 🔗](#page-0)

[7.4 Module Description](#page-0)


8. Roles and Responsibilities 9. Terms and Definitions 10. Project Schedule 11. Supporting References 12. Appendix [URL 🔗](#page-0)

12.1 API Endpoints 12.2 Troubleshooting 13. Revision History [URL 🔗](#page-0)
...
● Repository: https://github.com/quytru28-art/sensor-integration-system [URL 🔗](https://github.com/quytru28-art/sensor-integration-system)
...
- Provider: Railway (https://railway.app) [URL 🔗](https://railway.app)
...
- [URL: https://sensor-integration-system-production.up.railway.app](https://sensor-integration-system-production.up.railway.app)
...
- 1. git push origin main triggers deployment

- 2. Railway pulls code, builds Docker image

- 3. New container spawns, health checks pass

- 4. Traffic switches (zero-downtime deployment)

- 5. Old container removed after 30 seconds
...
Critical: Never commit to Git, use random hex
...
Technical direction, Railway deployment, code review, documentation
...
React components, UI/UX design, responsive CSS styling

Backend Dev

All

API endpoints, SQL schema design, authentication logic

DevOps

All

Docker configuration, Git workflow, CI/CD pipeline management

QA / Writer All

Functional testing, bug tracking, documentation maintenance
...
- Node.js Documentation: https://nodejs.org/docs/latest-v18.x/api/ [URL 🔗](https://nodejs.org/docs/latest-v18.x/api/)

- Express.js Documentation: https://expressjs.com/en/4x/api.html

- React Documentation: ● SQLite Documentation: ● Docker Documentation: https://www.sqlite.org/docs.html [URL 🔗](https://react.dev/)

- [https://docs.docker.com/](https://docs.docker.com/)

- Railway Documentation: https://docs.railway.app/ [URL 🔗](https://docs.railway.app/)
...
- GitHub Repository: ● Live Deployment: https://sensor-integration-system-production.up.railway.app [URL 🔗](https://sensor-integration-system-production.up.railway.app)

- Docker Hub (Base Image): https://hub.docker.com/_/node [URL 🔗](https://hub.docker.com/_/node)

- [https://github.com/quytru28-art/sensor-integration-system](https://github.com/quytru28-art/sensor-integration-system)

## Security Standards & Best Practices:

- OWASP Top 10 Web Application Security: https://owasp.org/www-project-top-ten/

- JWT Security Best Practices: ● REST API Design Guidelines: https://restfulapi.net/ [URL 🔗](https://tools.ietf.org/html/rfc8725)

- bcrypt Hashing Guide: https://auth0.com/blog/hashing-in-action-understanding-bcrypt/ [URL 🔗](https://auth0.com/blog/hashing-in-action-understanding-bcrypt/)

- [https://tools.ietf.org/html/rfc8725](https://tools.ietf.org/html/rfc8725)

## Educational Resources:

- React Hooks Documentation: https://react.dev/reference/react [URL 🔗](https://react.dev/reference/react)

- Docker for Beginners: https://docker-curriculum.com/ [URL 🔗](https://docker-curriculum.com/)

- SQLite Tutorial: https://www.sqlitetutorial.net/ [URL 🔗](https://www.sqlitetutorial.net/)
...
○ Headers: Authorization: Bearer <token>
○ Returns: [{ id, username, email, is_admin, device_count,
created_at }]
...
○ Headers: Authorization: Bearer <token>
○ Returns: { totalUsers, totalDevices, totalReadings,
newUsersToday }
...
- POST /api/superadmin/users/:id/reset-password - Reset user password ○ Headers: Authorization: Bearer <token>

- Returns: { message, tempPassword, username, email }

- PATCH /api/superadmin/users/:id/make-admin - Promote user to admin ○ Headers: Authorization: Bearer <token> ○ Returns: { message }
...
| Versio | Date Author |   | Description of Changes |
| --- | --- | --- | --- |
| n |   |   |   |
| 0.1 | 2026-02- | Team | Initial draft - project structure and requirements |
|   | 15 | #2 |   |
...
2026-02- Team Added backend implementation (authentication, devices,

#2

sensor data)

2026-02- Team Added admin panel functionality and user management

#2

2026-02- Team Initial release - complete documentation for basic features

#2

2026-02- Team Added super admin features, activity logging, physical layout
